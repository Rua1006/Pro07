...
<div class="cotent column text-center">
  <h2 class="newsInsert_tit">언론홍보자료 작성</h2>
  <form action="${path1}/news/insert.do" class="insertForm" method="post">
    <table>
      <tbody>
      <tr>
        <th>제목</th>
    ...
    <div class="button_group">
      ...
      <a href="${path1}/news/list.do" class="button list_go">목록</a>
    </div>
  </form>
</div>
<%-- 하단푸터 --%>
